...
**This version is just a showcase and just the base code to create a t3theme extension.** The scope of t3themes end there, where the **structured content** scope begins. We hope, that strict seperation of theme and content  will be positive to for the development of structured content. T3themes only work with EXT:t3cms. You will find further information about t3ms in its Documentation_.
